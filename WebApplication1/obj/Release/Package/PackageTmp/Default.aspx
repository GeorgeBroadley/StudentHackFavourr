...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        ...
        <p>
            <asp:Label ID="LogWarn" runat="server" Text="You need to log in to claim Favourrs" Visible="False" ForeColor="Red" Font-Underline="True"></asp:Label>
            ...
            <!--OnClick="ImageButton_Click"-->
        <asp:Panel ID="favoursTable" runat="server">
        </asp:Panel>
    </div>
